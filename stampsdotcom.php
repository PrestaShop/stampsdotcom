...
class StampsDotCom extends Module
{
	protected $config_form = false;

	public function __construct()
	{
		$this->name = 'stampsdotcom';
		$this->tab = 'others';
		$this->version = '13.1';
		$this->author = 'Stamps.com';

		$this->bootstrap = true;

		parent::__construct();

		$this->displayName = $this->l('Stamps.com');
		$this->description = $this->l('Automate your USPS shipping.');
